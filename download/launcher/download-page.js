...
let RESOURCE_TYPE = "Java/Launcher/HMCL";  // 当前选中的资源类型
...
function requestLatestData(){
    if(!(RESOURCE_TYPE in RESOURCE_LATEST_VERSION_CACHE)){
        ...
        console.log(AJAX_URL + RESOURCE_TYPE + "/latest");
...
window.onload = function () {
    ...
    for(let i = 0; i < top_btn.length; i++){
        top_btn[i].addEventListener("click", function () {
            ...
            switch (i){
                case 0:
                    RESOURCE_TYPE = "Java/Launcher/HMCL";
                    break;

                case 1:
                    RESOURCE_TYPE = "Java/Launcher/PCL";
                    break;

                case 2:
                    RESOURCE_TYPE = "Java/Launcher/OFFICIAL";
                    break;
            }
